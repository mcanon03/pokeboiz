<template>
    <div>
        ...
        <ul>
            <li class="img" v-for="defaultSprite in defaultSprites" :key="defaultSprite">
        ...
        <h2 class="header">Type</h2>
            <p class="header list" v-for="type in pokemon.types" :key="type.name"> {{ type.type.name }} 

        <h2 class="header">Moves</h2>
        <ul class="col-4">
            <li class="list" v-for="move in pokemon.moves" :key="move.name"> {{ move.move.name }} </li>
        </ul>
    </div>
</template>
